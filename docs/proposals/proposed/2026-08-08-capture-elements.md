...
Successor to [docs/proposals/done/2026-08-03-capture.md](../done/2026-08-03-capture.md), delivered
...
Siblings: `docs/proposals/proposed/2026-08-04-generalize-ask-kinds.md` (stage 2 is its fourth
caller) and `docs/proposals/proposed/2026-08-04-generalize-capture-shapes.md`.
...
6. **Does the untagged path get a template?**  ../done/2026-08-03-capture.md took
