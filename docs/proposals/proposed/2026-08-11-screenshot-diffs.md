...
docs/proposals/done/2026-08-11-browser-driver.md owns the toolchain question whole, and this
...
- **Downstream of an unproven driver.** Nothing here runs until
  docs/proposals/done/2026-08-11-browser-driver.md lands, and on this machine today it has not.
