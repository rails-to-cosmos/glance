...
- **`C-x` is cut while a selection lives.** `frontend/glue/70-shell.js:88` —
  *"a live selection makes C-c and C-x copy and cut"* — and the dispatch
  ...
  in `../done/2026-08-15-a-relation-is-a-link-with-a-kind.md`.
...
With `../proposed/2026-08-18-a-session-is-a-name-a-row-points-at.md` landed, a step
...
(`../done/2026-08-10-generalize-command-kinds.md`), the popup surfaces
(`../partial/2026-08-18-generalize-popup-surface-registry.md`), the keymap dialects
(`../proposed/2026-08-15-generalize-keymap-dialects.md`), the query language, and
