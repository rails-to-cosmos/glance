...
`docs/proposals/done/2026-08-05-glue-extraction.md`, which made the shell a real `.js` file
and stopped there
...
`docs/proposals/partial/2026-08-09-elm-sheet.md`, which plans around the real number.
