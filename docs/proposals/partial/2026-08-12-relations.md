...
[`../done/2026-08-15-a-relation-is-a-link-with-a-kind.md`](../done/2026-08-15-a-relation-is-a-link-with-a-kind.md);
...
2. **the kind**, optional — narrowed over the kinds the tree already uses,
   ...
   pressed"](../done/2026-08-15-a-relation-is-a-link-with-a-kind.md).
