...
carry no id (`docs/proposals/2026-08-15-a-relation-is-a-link-with-a-kind.done.md`).
...
`2026-08-18-generalize-popup-surface-registry.partial.md` lands. The query
...
4. **`session:` and `visited:` as query columns** touch the column registry —
   check the grain against `2026-08-15-one-row-per-column.proposed.md` before
   spelling them.
