...
{
	if (region.a6.H === region.bm.H)
	{
		return 'on line ' + region.a6.H;
	}
	return 'on lines ' + region.a6.H + ' through ' + region.bm.H;
}
...
var $author$project$Listing$Model = F6(
	function (cols, rows, at, flags, hint, narrow) {
		return {aG: at, aJ: cols, O: flags, bu: hint, ay: narrow, B: rows};
	});
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bo: fragment, bv: host, bH: path, bJ: port_, bM: protocol, bN: query};
	});
...
var $author$project$Listing$Column = F4(
	function (key, header, kind, badges) {
		return {be: badges, bs: header, by: key, l: kind};
	});
var $author$project$Listing$Badge = F2(
	function (value, colour) {
		return {ce: colour, bZ: value};
	});
...
var $author$project$Listing$Row = F3(
	function (id, cells, colour) {
		return {ab: cells, ce: colour, c: id};
	});
			...
			$elm$core$String$toLower(
				A2(
					...
					A2(
						$elm$core$List$map,
						function (c) {
							return A2($author$project$Listing$cellOf, r, c.by);
						},
						m.aJ))));
	});
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'flags',
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, m.O)),
				_Utils_Tuple2(
				'narrow',
				A2(
					$elm$core$Maybe$withDefault,
					$elm$json$Json$Encode$null,
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$string, m.ay))),
				_Utils_Tuple2(
				'all',
				$elm$json$Json$Encode$int(
					$elm$core$List$length(m.B)))
			]));
};
						...
						function () {
							if (!landing.$) {
								...
								return _Utils_update(
									filled,
									{
										aG: A2($author$project$Listing$placeOf, filled, id)
									});
							} else {
								return filled;
							}
				...
				return $author$project$Listing$told(
					$author$project$Listing$clamp(
						_Utils_update(
							model,
							{
								aG: A2($author$project$Listing$placeOf, model, id)
							})));
			case 2:
				var by = msg.a;
				return $author$project$Listing$told(
...
var $author$project$Listing$head = function (c) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$attribute, 'data-key', c.by)
			]),
		_List_fromArray(
			[
				A2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$core$List$member, r.c, m.O) ? $elm$core$Maybe$Just('tv-flagged') : $elm$core$Maybe$Nothing,
						_Utils_eq(i, m.aG) ? $elm$core$Maybe$Just('tv-sel') : $elm$core$Maybe$Nothing
					])));
	});
var $elm$html$Html$td = _VirtualDom_node('td');
var $author$project$Listing$viewCell = F2(
	function (r, c) {
		var val = A2($author$project$Listing$cellOf, r, c.by);
		var hue = $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (b) {
					return _Utils_eq(b.bZ, val);
				},
				c.be));
		var _v0 = _Utils_Tuple2(c.l, hue);
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$attribute, 'style', '--tv-badge:' + b.ce)
							]),
						_List_fromArray(
							[
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						'color',
						A2($elm$core$Maybe$withDefault, '', r.ce))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(val)
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$tr,
											_List_Nil,
											A2($elm$core$List$map, $author$project$Listing$head, m.aJ))
										])),
									A2(
									$elm$html$Html$tbody,
									_List_Nil,
...
var $author$project$Listing$main = $elm$browser$Browser$element(
	{
		...
		cW: $author$project$Listing$update,
		cX: $author$project$Listing$view
	});
var $author$project$Doc$Ignore = {$: 24};
...
var $author$project$Doc$empty = {at: $elm$core$Array$empty, aG: 0, T: false, av: $elm$core$Maybe$Nothing, O: _List_Nil, x: $elm$core$Set$empty, P: $elm$core$Maybe$Nothing, U: 1, aN: _List_Nil, aO: _List_Nil, aA: $elm$core$Array$empty, z: _List_Nil, A: $elm$core$Maybe$Nothing, am: _List_Nil, cK: _List_Nil, B: _List_Nil, Y: 0, g: $elm$core$Set$empty, aB: $elm$core$Maybe$Nothing, aW: $elm$core$Maybe$Nothing};
var $author$project$Doc$AddProp = F2(
	function (a, b) {
		return {$: 21, a: a, b: b};
	});
var $author$project$Doc$Broader = {$: 5};
var $author$project$Doc$Clear = {$: 1};
var $author$project$Doc$ClearFlags = {$: 8};
...
var $author$project$Doc$DraftPair = {$: 14};
...
var $author$project$Doc$Finer = {$: 4};
var $author$project$Doc$Flag = function (a) {
	return {$: 6, a: a};
};
var $author$project$Doc$HideDone = {$: 19};
...
var $author$project$Body$Cell = F3(
	function (key, val, colour) {
		return {ce: colour, by: key, ba: val};
	});
...
var $author$project$Body$Kid = F4(
	function (index, level, line, cells) {
		return {ab: cells, aw: index, U: level, H: line};
	});
										...
										return function (index) {
											return function (level) {
												return function (alone) {
													return {_: alone, ab: cells, d: from, w: grain, c: id, aw: index, l: kind, U: level, al: name, t: owner, N: text, f: to, R: was};
												};
											};
										};
									};
...
var $author$project$Scan$Stop = F5(
	function (from, to, grain, name, up) {
		return {d: from, w: grain, al: name, f: to, cV: up};
	});
			...
			return A3(
				...
				_Utils_ap(
					A2(
						$elm$core$List$drop,
						1,
						A2($elm$core$List$map, $elm$core$Tuple$first, run.aM)),
					_List_fromArray(
						[run.f])));
		};
		var go = F2(
	...
	function (lines, own, headCells, kids) {
		...
		var owned = function (r) {
			...
			return _Utils_eq(stop, r.f) ? r : _Utils_update(
				r,
				{
					N: A3($author$project$Scan$cut, lines, r.d, stop),
					R: A3($author$project$Scan$cut, lines, r.d, stop)
				});
		};
		var descend = F3(
			function (seen, ks, out) {
				...
				while (true) {
					if (!ks.b) {
						...
						var cid = 'C' + $elm$core$String$fromInt(k.aw);
						var above = A2(
							$elm$core$List$filter,
							function (_v1) {
								var l = _v1.a;
								return _Utils_cmp(l, k.U) < 0;
							},
							seen);
...
var $author$project$Body$planEntries = F2(
	function (plan, summoned) {
		if (!summoned.$) {
			var key = summoned.a;
			return A2(
				$elm$core$List$any,
...
var $author$project$Doc$entriesOf = function (m) {
	return A2($author$project$Body$planEntries, m.z, m.av);
};
...
var $author$project$Body$metaRows = function (_v0) {
	...
	var planning = $elm$core$List$isEmpty(entries) ? _List_Nil : _List_fromArray(
		[
			...
			$author$project$Body$blank,
			{
				...
				l: 3,
				N: $author$project$Body$planningText(entries),
				R: $author$project$Body$planningText(entries)
			})
		]);
	var pair = F2(
		function (i, _v1) {
			...
			return _Utils_update(
				$author$project$Body$blank,
				{
					...
					l: 3,
					t: $elm$core$Maybe$Just($author$project$Body$drawerId),
					N: $author$project$Body$propertyText(
						_Utils_Tuple2(key, value)),
					R: $author$project$Body$propertyText(
						_Utils_Tuple2(key, value))
				});
		});
	var drawer = _Utils_update(
		$author$project$Body$blank,
		{
			...
			l: 3,
			al: $elm$core$Maybe$Just('properties')
		});
					...
					return A2(
						...
						_Utils_ap(
							$author$project$Body$metaRows(
								{
									ci: m.T,
									ck: $author$project$Doc$entriesOf(m),
									cK: m.cK
								}),
							rest));
				} else {
...
var $author$project$Doc$lineOf = F2(
	function (m, r) {
		return A2(
			$elm$core$Maybe$withDefault,
			'',
			A2($elm$core$Array$get, r.d, m.at));
	});
var $author$project$Doc$drawer = F2(
	function (m, r) {
		return (r.w === 1) && ((r.l === 3) || (!_Utils_eq(
			$author$project$Scan$drawerName(
...
var $author$project$Doc$fillD = A2(
	...
	function (m) {
		return A4(
			$elm$json$Json$Decode$map3,
			F3(
				function (props, plan, keys) {
					return $author$project$Doc$seedMeta(
						_Utils_update(
							m,
							{z: plan, am: keys, cK: props}));
				}),
			A2(
				$elm$json$Json$Decode$field,
				'props',
				...
				F8(
					function (lines, own, headCells, kids, links, spanAt, shift, level) {
						var seeded = _Utils_update(
							...
							{
								at: $elm$core$Array$fromList(lines),
								U: level,
								aN: lines,
								aO: links,
								aA: $author$project$Doc$offsetsOf(lines),
								Y: shift,
								aB: spanAt
							});
						return _Utils_update(
							seeded,
							{
								B: A4($author$project$Body$rowsFrom, lines, own, headCells, kids)
							});
					}),
				A2(
					$elm$json$Json$Decode$field,
	...
	function (m, i) {
		return A2(
			...
			A2(
				...
				A2($author$project$Scan$nth, i, m.B)));
	});
...
var $author$project$Doc$openedLen = A2(
	...
	$elm$core$Maybe$map(
		function (o) {
			return o.bw + $elm$core$String$length(o.aH);
		}));
...
var $author$project$Doc$openerAt = F2(
	function (m, r) {
		return ((r.w !== 2) || (r.l !== 1)) ? $elm$core$Maybe$Nothing : $author$project$Scan$listOpener(
			A2($author$project$Doc$lineOf, m, r));
	});
...
var $author$project$Doc$hiddenDone = function (m) {
	return $elm$core$Set$isEmpty(m.x) ? $elm$core$Set$empty : $elm$core$Set$fromList(
		A2(
			$elm$core$List$filterMap,
			function (r) {
				if (A2($author$project$Doc$isListRoot, m, r.c)) {
					return (A2($elm$core$Set$member, r.c, m.x) && A2($author$project$Doc$subtreeDone, m, r)) ? $elm$core$Maybe$Just(r.c) : $elm$core$Maybe$Nothing;
				} else {
					...
					if ((!_v0.a.$) && (!_v0.b.$)) {
						var root = _v0.b.a;
						return (A2($elm$core$Set$member, root, m.x) && A2($author$project$Doc$subtreeDone, m, r)) ? $elm$core$Maybe$Just(r.c) : $elm$core$Maybe$Nothing;
					} else {
						return $elm$core$Maybe$Nothing;
					}
				}
...
var $author$project$Doc$snapVisible = function (m) {
	...
	var landing = (A2(seek, 1, m.aG) >= 0) ? A2(seek, 1, m.aG) : A2(seek, -1, m.aG);
	return (A2(
		$elm$core$Set$member,
		A2($author$project$Doc$idAtRow, m, m.aG),
...
var $author$project$Doc$settled = function (m) {
	return $author$project$Doc$snapVisible(
		_Utils_eq(
			A2($author$project$Doc$idAtRow, m, m.aG),
			$author$project$Body$planId) ? m : _Utils_update(
			m,
...
var $author$project$Scan$closerOpen = function (line) {
	...
	if (!_v0.$) {
		...
		return $elm$core$Maybe$Just(
			{
				...
				aR: $author$project$Scan$verbatim(name),
		...
		if (!_v1.$) {
			return $elm$core$Maybe$Just(
				{
					aI: $author$project$Scan$indentOf(line) + ':END:',
					aR: false,
...
var $author$project$Scan$closerStep = F2(
	function (line, _v0) {
		...
		if (stack.b) {
			var top = stack.a;
			var below = stack.b;
			return top.g(line) ? _Utils_Tuple2(below, false) : (top.aR ? _Utils_Tuple2(stack, false) : A2($author$project$Scan$closerPush, line, stack));
		} else {
...
var $author$project$Body$bodyText = F2(
	function (m, gone) {
		var splice = F2(
			function (r, out) {
				if (A2($elm$core$List$member, r.c, gone)) {
					...
					if (!_Utils_eq(r.N, r.R)) {
						var typed = A2($elm$core$String$split, '\u000A', r.N);
						var written = _Utils_ap(
							typed,
							$author$project$Scan$closers(typed));
						var shift = $author$project$Body$indentIn(r.N) - $author$project$Body$indentIn(r.R);
						var cut = A2($author$project$Body$ownEnd, m.B, r);
						var under = A2(
							$elm$core$List$map,
						...
						return _Utils_ap(
							A2($elm$core$List$take, r.d, out),
							_Utils_ap(
								r._ ? A3($author$project$Body$apart, out, r.d, written) : written,
								_Utils_ap(
									under,
		...
		var moved = function (r) {
			return (r.l === 1) && (A2($elm$core$List$member, r.c, gone) || (!_Utils_eq(r.N, r.R)));
		};
		var spoken = A2(
			$elm$core$List$map,
			function ($) {
			...
			A2($elm$core$List$filter, moved, m.B));
		...
		var paras = $elm$core$List$reverse(
			A2(
				$elm$core$List$filter,
				function (r) {
					return (r.l === 1) && (!silenced(r));
				},
				m.B));
		return A2(
			$elm$core$String$join,
			'\u000A',
			A3($elm$core$List$foldl, splice, m.aN, paras));
	});
...
var $author$project$Doc$headerJSON = function (m) {
	return _List_fromArray(
		[
			_Utils_Tuple2(
			'properties',
			$author$project$Doc$pairsJSON(m.cK)),
			_Utils_Tuple2(
			'planning',
			$author$project$Doc$pairsJSON(m.z))
		]);
};
...
var $author$project$Body$rowAt = function (m) {
	return A2($author$project$Scan$nth, m.aG, m.B);
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'key',
				$elm$json$Json$Encode$string(c.by)),
				_Utils_Tuple2(
				'val',
				$elm$json$Json$Encode$string(c.ba)),
				_Utils_Tuple2(
				'colour',
				$elm$json$Json$Encode$string(c.ce))
			]));
};
var $author$project$Doc$charOf = F2(
	function (m, line) {
		return A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Array$get, line, m.aA));
	});
			...
			switch (_v1) {
				...
				case 1:
					return _Utils_eq(r.c, $author$project$Body$tailId) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
						_Utils_Tuple2(
							(base + m.Y) + A2($author$project$Doc$charOf, m, r.d),
							(base + m.Y) + A2($author$project$Doc$charOf, m, r.f)));
				default:
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(
							base,
...
var $author$project$Doc$foldable = F2(
	function (m, r) {
		return (r.l === 2) || A2($author$project$Doc$drawer, m, r);
	});
...
var $author$project$Doc$reachSpan = F2(
	function (m, r) {
		var _v0 = _Utils_Tuple2(m.aB, r.l);
		_v0$2:
		while (true) {
			if (!_v0.a.$) {
				switch (_v0.b) {
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					'kind',
					$elm$json$Json$Encode$string(
						$author$project$Body$kindWord(r.l))),
					_Utils_Tuple2(
					'fold',
					...
					A2(
						$elm$core$Maybe$withDefault,
						$elm$json$Json$Encode$null,
						A2($elm$core$Maybe$map, $elm$json$Json$Encode$string, r.al))),
					_Utils_Tuple2(
					'owner',
					A2(
						$elm$core$Maybe$withDefault,
						$elm$json$Json$Encode$null,
						A2($elm$core$Maybe$map, $elm$json$Json$Encode$string, r.t))),
					_Utils_Tuple2(
					'from',
					...
					_Utils_Tuple2(
					'text',
					$elm$json$Json$Encode$string(r.N)),
					_Utils_Tuple2(
					'index',
					$elm$json$Json$Encode$int(r.aw)),
					_Utils_Tuple2(
					'level',
					$elm$json$Json$Encode$int(r.U)),
					_Utils_Tuple2(
					'cells',
					A2($elm$json$Json$Encode$list, $author$project$Doc$cellJSON, r.ab)),
					_Utils_Tuple2(
					'span',
					function () {
	...
	function (id, m) {
		...
		return $author$project$Doc$told(
			_Utils_update(
				fresh,
				{
					aG: A2($author$project$Body$placeOf, fresh, id)
				}));
	});
			...
			if (!_v3.$) {
				...
				var word = function () {
					...
					if (!_v4.$) {
						...
						return (up.w === 2) ? 'item' : $author$project$Body$kindWord(up.l);
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
				...
				return (!r.l) ? _Utils_Tuple2(m, 'grain-broader (the whole entry)') : _Utils_Tuple2(
					_Utils_update(
						m,
						{
							aG: A2($author$project$Body$placeOf, m, 'H')
						}),
...
var $author$project$Body$Join = F6(
	function (under, line, marker, owner, alone, word) {
		return {_: alone, H: line, aQ: marker, t: owner, a9: under, b1: word};
	});
	...
	function (m, r, line) {
		return A3(
			...
			A2(
				$elm$core$List$filter,
				function (s) {
					return (s.l === 1) && ((!_Utils_eq(s.c, $author$project$Body$draftId)) && ((_Utils_cmp(s.d, line) < 1) && ((_Utils_cmp(line, s.f) < 0) && A2(
						$elm$core$List$member,
						r.c,
...
var $author$project$Body$anchored = F5(
	function (m, r, line, marker, word) {
		...
		return A6(
			...
			line,
			marker,
			(_Utils_cmp(line, host.f) > -1) ? host.t : $elm$core$Maybe$Just(host.c),
			false,
			word);
	});
var $author$project$Scan$closerAt = F2(
	function (reg, line) {
		return $author$project$Scan$closes(reg.l) && _Utils_eq(line, reg.f - 1);
	});
...
var $author$project$Body$pastWord = function (top) {
	...
	if (!_v0.$) {
		...
		return (top.w === 1) ? 'after the block' : 'after this paragraph';
	}
};
...
var $author$project$Scan$interiorEnd = function (reg) {
	return $author$project$Scan$closes(reg.l) ? (reg.f - 1) : reg.f;
};
...
var $author$project$Scan$within = F3(
	function (lines, reg, line) {
		var nested = A4(
			...
			line);
		return ((!nested.l) || A2($author$project$Scan$closerAt, nested, line)) ? reg : nested;
	});
...
var $author$project$Body$inside = F3(
	function (m, r, line) {
		...
		var lines = $elm$core$Array$fromList(m.aN);
		var reg = A4($author$project$Scan$regionAt, lines, top.d, top.f, line);
		return ((!reg.l) || A2($author$project$Scan$closerAt, reg, line)) ? A6(
			$author$project$Body$Join,
			top.c,
			reg.f,
			'',
			...
			$author$project$Body$regionWord(reg.l));
	});
var $author$project$Body$sibling = F2(
	function (m, r) {
		...
		return (_Utils_eq(
			top.al,
			$elm$core$Maybe$Just('list')) && (r.w === 2)) ? A6(
			$author$project$Body$Join,
			r.c,
			r.f,
			A2(
				$author$project$Body$itemMarker,
				$elm$core$Array$fromList(m.aN),
				r.d),
			r.t,
			false,
		...
		return A2(
			...
			function (j) {
				return A3(
					...
					m,
					j.a9,
					A2($author$project$Body$draftRow, j, j.aQ));
			},
		...
		if (_Utils_eq(id, $author$project$Body$planId)) {
			return A2(
				...
				$author$project$Doc$remeta(
					_Utils_update(
						m,
						{
							z: A2($author$project$Body$readPlanning, m.am, written)
						})));
		} else {
			var _v0 = _Utils_Tuple2(
			...
			if ((!_v0.a.$) && (!_v0.b.$)) {
				...
				var pairsWith = function (now) {
					return _Utils_ap(
						A2($elm$core$List$take, i, m.cK),
						_Utils_ap(
							now,
							A2($elm$core$List$drop, i + 1, m.cK)));
				};
				var _v2 = A2($author$project$Body$planningKey, m.am, key);
				if (!_v2.$) {
					var word = _v2.a;
					return A2(
...
var $author$project$Doc$planFiner = function (m) {
	var want = 1 + A2($elm$core$Maybe$withDefault, -1, m.A);
	var entries = $author$project$Doc$entriesOf(m);
...
var $author$project$Doc$finer = function (m) {
	...
	if (_v0.$ === 1) {
		...
		var entered = (!r.l) ? ($elm$core$List$length(m.B) > 1) : (kids > 0);
		return _Utils_eq(r.c, $author$project$Body$planId) ? $author$project$Doc$planFiner(m) : ($author$project$Doc$heading(r) ? (entered ? _Utils_Tuple2(
			_Utils_update(
				m,
				{aG: m.aG + 1}),
			...
			A4(
				$author$project$Doc$grainWord,
				'grain-finer',
				A2($elm$core$Maybe$withDefault, 'item', r.al),
				1,
				kids)) : ((r.w === 2) ? _Utils_Tuple2(m, 'grain-finer (at the finest)') : _Utils_Tuple2(m, 'grain-finer (nothing finer here)'))));
	}
};
...
var $author$project$Body$joinLine = F3(
	function (m, id, caret) {
		return A2(
			$elm$core$Maybe$map,
			function (j) {
				return (j._ && ((j.H > 1) && (!A2($author$project$Scan$blankAt, j.H - 1, m.aN)))) ? (j.H + 1) : j.H;
			},
			A3($author$project$Body$joinAt, m, id, caret));
	});
...
var $author$project$Doc$narrowed = F2(
	function (m, text) {
		var deepen = function (line) {
			var n = $author$project$Doc$starsAt(line);
			return ((n > 0) && ((_Utils_cmp(n, m.U) < 1) && $author$project$Doc$headlineAt(line))) ? _Utils_ap(
				A2($elm$core$String$repeat, m.U + 1, '*'),
...
var $author$project$Doc$nextVisible = F2(
	function (by, m) {
		var total = $elm$core$List$length(m.B);
		var gone = A2(
			$elm$core$Set$union,
			$author$project$Doc$hiddenDone(m),
			$author$project$Doc$hiddenIn(m));
		...
		var covering = A3(
			...
			F2(
				function (_v6, held) {
					var i = _v6.a;
					var r = _v6.b;
					return ((_Utils_cmp(r.d, line) < 1) && (_Utils_cmp(line, r.f) < 0)) ? $elm$core$Maybe$Just(i) : held;
				}),
			$elm$core$Maybe$Nothing,
			stops);
	...
	function (m, line) {
		return A2(
			...
			A2(
				$author$project$Scan$indexWhere,
				function (r) {
					return (r.l === 1) && _Utils_eq(r.d, line);
				},
				m.B));
	});
		...
		return _Utils_Tuple2(
			...
			function () {
				var _v0 = A2(
					$elm$core$List$filter,
					function (k) {
						return (k.l === 2) && ((_Utils_cmp(k.d, r.d) > 0) && (_Utils_cmp(k.U, r.U) < 1));
					},
					m.B);
				if (_v0.b) {
					var next = _v0.a;
					...
					return $elm$core$List$length(m.aN);
				}
			}());
	});
		...
		if (_v0.$ === 1) {
			...
			if (!r.l) {
				...
				if (r.l !== 2) {
					...
					if ((by < 0) && (_Utils_cmp(r.U, m.U + 1) < 1)) {
						...
						var deepen = function (k) {
							return ((_Utils_cmp(k.d, from) > -1) && ((_Utils_cmp(k.d, to) < 0) && ((k.l === 2) || (k.l === 1)))) ? _Utils_update(
								k,
								{U: k.U + by}) : k;
						};
						var fresh = A3(
						...
						return A2(
							$author$project$Doc$composedWith,
							$elm$core$Maybe$Just(
								word + (' (level ' + ($elm$core$String$fromInt(r.U + by) + ')'))),
							_Utils_update(
								m,
								{
									at: $elm$core$Array$fromList(fresh),
									aN: fresh,
									aA: $author$project$Doc$offsetsOf(fresh),
									B: A2($elm$core$List$map, deepen, m.B)
								}));
					}
				}
			}
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 0:
				...
				var landed = function () {
					var _v1 = _Utils_Tuple2(fresh.P, model.P);
					if (!_v1.a.$) {
						var line = _v1.a.a;
			...
			case 4:
				...
				var _v6 = $author$project$Doc$finer(opened);
				var fined = _v6.a;
				var word = _v6.b;
				return (_Utils_eq(fined.aG, model.aG) && (_Utils_eq(fined.A, model.A) && _Utils_eq(fined.g, model.g))) ? $author$project$Doc$told(
					A2($author$project$Doc$nextVisible, 1, model)) : $author$project$Doc$spoke(
					_Utils_Tuple2(fined, word));
			case 5:
				var _v8 = $author$project$Doc$broader(model);
				var broadened = _v8.a;
				var word = _v8.b;
				return (_Utils_eq(broadened.aG, model.aG) && _Utils_eq(broadened.A, model.A)) ? $author$project$Doc$told(
					A2($author$project$Doc$nextVisible, -1, model)) : $author$project$Doc$spoke(
					_Utils_Tuple2(broadened, word));
			case 6:
				var id = msg.a;
				return $author$project$Doc$told(
					_Utils_update(
			...
			case 19:
				...
				var next = function () {
					if (!scoped.$) {
						var root = scoped.a;
						return A2($elm$core$Set$member, root, model.x) ? A2($elm$core$Set$remove, root, model.x) : A2($elm$core$Set$insert, root, model.x);
					} else {
						return $elm$core$Set$isEmpty(model.x) ? $elm$core$Set$fromList(
			...
			case 18:
				...
				if (_v12.$ === 1) {
					...
					var r = _v12.a;
					var opened = A2($elm$core$Set$member, r.c, model.g);
					return $author$project$Doc$spoke(
						_Utils_Tuple2(
							_Utils_update(
								model,
								{
									aG: A2($author$project$Body$placeOf, model, r.c),
									g: opened ? A2($elm$core$Set$remove, r.c, model.g) : A2($elm$core$Set$insert, r.c, model.g)
								}),
							'org-cycle (' + (((r.l === 2) ? 'subtree' : A2($elm$core$Maybe$withDefault, 'drawer', r.al)) + (opened ? ' open)' : ' folded)'))));
				}
			case 20:
				var by = msg.a;
			...
			case 21:
				var key = msg.a;
				var value = msg.b;
				var _v13 = A2($author$project$Body$planningKey, model.am, key);
				if (!_v13.$) {
					var word = _v13.a;
					return A2(
						$author$project$Doc$composedWith,
			...
			case 9:
				...
				var keptProps = A2($elm$core$List$member, $author$project$Body$drawerId, ids) ? _List_Nil : A2(
					...
					A2(
						...
						A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, model.cK)));
				var keptPlan = A2($elm$core$List$member, $author$project$Body$planId, ids) ? _List_Nil : model.z;
				var model_ = $author$project$Doc$remeta(
					_Utils_update(
						model,
						{z: keptPlan, cK: keptProps}));
				var cut = $elm$core$List$length(model.aN) - $elm$core$List$length(
					A2($elm$core$String$split, '\u000A', written));
				var landsOn = function () {
					var _v14 = $elm$core$List$head(taken);
					if (_v14.$ === 1) {
						return model.P;
					} else {
						var first = _v14.a;
						var kin = A2(
							$elm$core$List$filter,
							function (r) {
								return (r.l === 1) && (_Utils_eq(r.t, first.t) && (!A2(
									$elm$core$List$member,
									r.c,
									A2(
										$elm$core$List$map,
						...
						if (_v15.b) {
							...
							var _v16 = $elm$core$List$reverse(
								A2(
									$elm$core$List$filter,
									function (r) {
										return _Utils_cmp(r.d, first.d) < 0;
				...
				var done = A2(
					$author$project$Doc$landOn,
					A2($author$project$Doc$idAtRow, model, model.aG),
					_Utils_update(
						model_,
						{P: landsOn}));
				...
				if (_Utils_eq(
					...
					var write = function (r) {
						return _Utils_eq(r.c, id) ? _Utils_update(
							r,
							{
								N: A2($author$project$Doc$narrowed, model, written)
							}) : r;
					};
					return $author$project$Doc$composed(
						_Utils_update(
							model,
							{
								B: A2($elm$core$List$map, write, model.B)
							}));
				}
			case 11:
				var id = msg.a;
			...
			case 14:
				...
				return $author$project$Doc$told(
					_Utils_update(
						fresh,
						{
							aG: A2($author$project$Body$placeOf, fresh, $author$project$Body$draftPairId),
							g: A2($elm$core$Set$remove, $author$project$Body$drawerId, fresh.g)
						}));
			case 15:
				var id = msg.a;
...
var $author$project$Doc$stars = F2(
	function (m, level) {
		return A2(
			$elm$core$String$repeat,
			A2($elm$core$Basics$max, 0, 2 * (level - m.U)),
			' ') + '* ';
	});
...
var $author$project$Doc$inset = F2(
	function (m, r) {
		return (_Utils_cmp(r.U, m.U) > 0) ? _List_fromArray(
			[
				A2(
				...
				'--g-doc-indent:' + ($elm$core$String$fromInt(
					$elm$core$String$length(
						A2($author$project$Doc$stars, m, r.U))) + (';' + A2($author$project$Doc$rail, m, r.U))))
			]) : _List_Nil;
	});
var $author$project$Doc$litOf = function (m) {
	return {
		aK: $author$project$Doc$hiddenDone(m),
		a2: $elm$core$Set$fromList(
			A2(
				$elm$core$List$filterMap,
				function ($) {
					return $.t;
...
var $author$project$Doc$compactedRun = F3(
	function (m, done, r) {
		return A2($author$project$Doc$isListRoot, m, r.c) && (A2($elm$core$Set$member, r.c, m.x) && ((!A2($elm$core$Set$member, r.c, done)) && A2(
			$elm$core$List$any,
			function (h) {
				return _Utils_eq(
...
var $author$project$Doc$markOf = F4(
	function (lit, m, i, r) {
		return _Utils_eq(i, m.aG) ? '' : (A2($elm$core$List$member, r.c, lit.aY) ? (' up up-' + $elm$core$String$fromInt(
			A2(
				$elm$core$Basics$min,
				2,
				A2(
					$elm$core$Maybe$withDefault,
					0,
					A2($author$project$Doc$indexOfIn, r.c, lit.aY))))) : (((!_Utils_eq(r.t, $elm$core$Maybe$Nothing)) && _Utils_eq(r.t, lit.a5)) ? ' sib' : ''));
	});
		...
		return _Utils_ap(
			...
			_Utils_ap(
				function () {
					...
					switch (_v0) {
						case 2:
							return (r.l === 3) ? 'meta' : 'item';
						case 1:
							return 'comp d-' + A2($elm$core$Maybe$withDefault, '', r.al);
						default:
							return $author$project$Body$kindWord(r.l);
					}
				}(),
				_Utils_ap(
					_Utils_eq(i, m.aG) ? ' dat' : '',
					_Utils_ap(
						A2($elm$core$List$member, r.c, m.O) ? ' dfl' : '',
						_Utils_ap(
							top ? ' lvl-top' : '',
							_Utils_ap(
								_Utils_eq(r.c, $author$project$Body$tailId) ? ' d-tail' : '',
								_Utils_ap(
									A2($elm$core$Set$member, r.c, lit.aK) ? ' d-hidden' : '',
									_Utils_ap(
										A3($author$project$Doc$compactedRun, m, lit.aK, r) ? ' d-compacted' : '',
										_Utils_ap(
											A2($author$project$Doc$drawer, m, r) ? (A2($elm$core$Set$member, r.c, lit.a2) ? ' d-drawer' : ' d-drawer bare') : '',
...
var $author$project$Doc$drawText = F3(
	function (m, body, base) {
		...
		return A3(
			go,
			A2($elm$core$List$filter, inside, m.aO),
			0,
			_List_Nil);
	});
...
var $author$project$Doc$drawnCells = function (r) {
	return (!r.l) ? A2(
		$elm$core$List$filter,
		function (c) {
			return (c.ba !== '') || (c.by === 'title');
		},
		r.ab) : $author$project$Body$shown(r);
};
				...
				F2(
					function (j, c) {
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('dc dc-' + c.by),
									A2($elm$html$Html$Attributes$style, 'color', c.ce)
								]),
							function () {
								var _v0 = _Utils_Tuple3(c.by, r.l, m.aW);
								_v0$2:
								while (true) {
									if (_v0.a === 'title') {
										switch (_v0.b) {
											case 0:
												if (!_v0.c.$) {
													var _v1 = _v0.b;
													var t = _v0.c.a;
													return A3($author$project$Doc$drawText, m, c.ba, t);
												} else {
													break _v0$2;
												}
											case 2:
...
var $author$project$Doc$keyOf = function (r) {
	return ((r.l === 3) && (r.w === 2)) ? A2(
		$elm$core$Maybe$map,
		$elm$core$Tuple$first,
		$author$project$Body$readProperty(r.N)) : $elm$core$Maybe$Nothing;
};
	...
	function (op, head) {
		if (!op.$) {
			...
			var tok = A3(
				$elm$core$String$slice,
				o.bw,
				o.bw + $elm$core$String$length(
					$elm$core$String$trimRight(o.aH)),
				head);
			return $author$project$Doc$stepsAside(tok) ? _List_fromArray(
				[
					$elm$html$Html$text(
					A2($elm$core$String$left, o.bw, head)),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
						[
					...
					A2(
						$elm$core$String$dropLeft,
						o.bw + $elm$core$String$length(tok),
						head))
				]) : _List_fromArray(
				[
...
var $author$project$Doc$viewPara = F2(
	function (m, r) {
		...
		var k = A2(
			...
			op,
			A2($author$project$Doc$lineOf, m, r));
		var rest = A2($elm$core$String$dropLeft, k, r.N);
		var box = A3($elm$core$String$slice, opened, k, r.N);
		var mark = (k <= 0) ? _List_Nil : A2(
			...
			A2(
				...
				A2(
					...
					op,
					A2($elm$core$String$left, opened, r.N))),
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									A3($author$project$Scan$cut, m.aN, mark, parent.f))
								]))
						])) : out;
			});
		var rowN = function (j) {
			return A2($author$project$Scan$nth, j, m.B);
		};
		var n = $elm$core$List$length(m.B);
		var go = F3(
			function (j, mark, out) {
							...
							var gap = (_Utils_cmp(kid.d, mark) > 0) ? _List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											A3($author$project$Scan$cut, m.aN, mark, kid.d))
										]))
								]) : _List_Nil;
							var _v1 = function () {
								if (under) {
									...
									var own = (_Utils_cmp(headAt, kid.d) > 0) ? _List_fromArray(
										[
											...
											_Utils_update(
												kid,
												{
													N: A3($author$project$Scan$cut, m.aN, kid.d, headAt),
													f: headAt
												}))
										]) : _List_Nil;
	...
	function (lit, m, parent, from) {
		var walk = F2(
			function (j, got) {
				walk:
				while (true) {
					var _v0 = A2($author$project$Scan$nth, j, m.B);
					if (!_v0.$) {
						var kid = _v0.a;
						if ((kid.l === 3) && _Utils_eq(
							kid.t,
							$elm$core$Maybe$Just(parent.c))) {
							var $temp$j = j + 1,
								$temp$got = _Utils_ap(
...
var $author$project$Doc$crumb = F2(
	function (m, r) {
		...
		if (r.l === 2) {
			var t = A2($author$project$Body$cellOf, 'title', r);
			return clip(
				$elm$core$String$isEmpty(t) ? 'child' : t);
		} else {
			if (r.w === 1) {
				return A2($author$project$Doc$drawer, m, r) ? (':' + ($elm$core$String$toUpper(
					A2($elm$core$Maybe$withDefault, 'drawer', r.al)) + ':')) : A2($elm$core$Maybe$withDefault, 'item', r.al);
			} else {
				return clip(
					function () {
						var _v0 = _Utils_Tuple2(
							r.l,
							$author$project$Body$readProperty(r.N));
						if ((_v0.a === 3) && (!_v0.b.$)) {
							var _v1 = _v0.a;
							var _v2 = _v0.b.a;
							var key = _v2.a;
...
var $author$project$Doc$view = function (m) {
	...
	var opener = function (r) {
		return (r.l === 3) ? $author$project$Doc$token('PROPERTIES') : _List_fromArray(
			[
				$elm$html$Html$text(
				A2(
					$elm$core$Maybe$withDefault,
					'',
					A2($author$project$Scan$nth, r.d, m.aN)))
			]);
	};
	var n = $elm$core$List$length(m.B);
			...
			while (true) {
				if (_Utils_cmp(i, n) > -1) {
					...
					var r = A2(
						...
						$author$project$Body$blank,
						A2($author$project$Scan$nth, i, m.B));
					if ((r.l === 2) && (_Utils_cmp(r.U, level) < 1)) {
						return _Utils_Tuple2(out, i);
					} else {
						if (A2($elm$core$Set$member, r.c, hidden)) {
							...
							if (r.l === 2) {
								...
								var _v0 = A3(go, i + 1, r.U, _List_Nil);
								var inner = _v0.a;
								var j = _v0.b;
								var $temp$i = j,
									$temp$level = level,
								...
								if (r.w === 1) {
									var _v1 = (r.l === 3) ? A4($author$project$Doc$viewMeta, lit, m, r, i + 1) : A6($author$project$Doc$viewKids, lit, m, r, i + 1, r.d, 0);
									var inner = _v1.a;
									var j = _v1.b;
	...
	var body = function () {
		...
		if (_v2.b) {
			...
			var _v3 = A3(go, 1, m.U, _List_Nil);
			var inner = _v3.a;
			return A2(
				$elm$core$List$cons,
				headline,
				A3(blkOf, 'H', m.U, inner));
		} else {
			return _List_Nil;
		}
	}();
...
var $author$project$Doc$main = $elm$browser$Browser$element(
	{
		...
		cW: $author$project$Doc$update,
		cX: $author$project$Doc$view
	});
