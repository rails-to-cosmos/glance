...
{
	if (region.a9.J === region.bp.J)
	{
		return 'on line ' + region.a9.J;
	}
	return 'on lines ' + region.a9.J + ' through ' + region.bp.J;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ct: 'hidden', cf: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ct: 'mozHidden', cf: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ct: 'msHidden', cf: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ct: 'webkitHidden', cf: 'webkitvisibilitychange' }
		: { ct: 'hidden', cf: 'visibilitychange' };
}
...
var $author$project$Listing$Model = F6(
	function (cols, rows, at, flags, hint, narrow) {
		return {aI: at, aL: cols, R: flags, bx: hint, aA: narrow, D: rows};
	});
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {br: fragment, by: host, bK: path, bM: port_, bP: protocol, bQ: query};
	});
...
var $author$project$Listing$Column = F4(
	function (key, header, kind, badges) {
		return {bh: badges, bv: header, bB: key, k: kind};
	});
var $author$project$Listing$Badge = F2(
	function (value, colour) {
		return {ch: colour, b0: value};
	});
...
var $author$project$Listing$Row = F3(
	function (id, cells, colour) {
		return {ad: cells, ch: colour, c: id};
	});
			...
			$elm$core$String$toLower(
				A2(
					...
					A2(
						$elm$core$List$map,
						function (c) {
							return A2($author$project$Listing$cellOf, r, c.bB);
						},
						m.aL))));
	});
		...
		_List_fromArray(
			[
				...
				A2(
					...
					A2($elm$core$Maybe$map, $elm$json$Json$Encode$string, m.aA))),
				_Utils_Tuple2(
				'all',
						...
						function () {
							if (!landing.$) {
								...
								return _Utils_update(
									filled,
									{
										aI: A2($author$project$Listing$placeOf, filled, id)
									});
							} else {
								return filled;
							}
				...
				return $author$project$Listing$told(
					$author$project$Listing$clamp(
						_Utils_update(
							model,
							{
								aI: A2($author$project$Listing$placeOf, model, id)
							})));
			case 2:
				var by = msg.a;
				return $author$project$Listing$told(
...
var $author$project$Listing$head = function (c) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$attribute, 'data-key', c.bB)
			]),
		_List_fromArray(
			[
				A2(
			...
			A2(
				...
				_List_fromArray(
					[
						...
						A2($elm$core$List$member, r.c, m.R) ? $elm$core$Maybe$Just('tv-flagged') : $elm$core$Maybe$Nothing,
						_Utils_eq(i, m.aI) ? $elm$core$Maybe$Just('tv-sel') : $elm$core$Maybe$Nothing
					])));
	});
var $elm$html$Html$td = _VirtualDom_node('td');
var $author$project$Listing$viewCell = F2(
	function (r, c) {
		var val = A2($author$project$Listing$cellOf, r, c.bB);
		var hue = $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				function (b) {
					return _Utils_eq(b.b0, val);
				},
				c.bh));
		var _v0 = _Utils_Tuple2(c.k, hue);
					...
					[
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$attribute, 'style', '--tv-badge:' + b.ch)
							]),
						_List_fromArray(
							[
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						'color',
						A2($elm$core$Maybe$withDefault, '', r.ch))
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(val)
								...
								[
									...
									_List_fromArray(
										[
											...
											$elm$html$Html$tr,
											_List_Nil,
											A2($elm$core$List$map, $author$project$Listing$head, m.aL))
										])),
									A2(
									$elm$html$Html$tbody,
									_List_Nil,
...
var $author$project$Doc$empty = {av: $elm$core$Array$empty, aI: 0, e: $elm$core$Maybe$Nothing, V: false, ax: $elm$core$Maybe$Nothing, n: false, R: _List_Nil, z: $elm$core$Set$empty, L: $elm$core$Maybe$Nothing, W: 1, aP: _List_Nil, aQ: _List_Nil, aC: $elm$core$Array$empty, B: _List_Nil, C: $elm$core$Maybe$Nothing, ao: _List_Nil, aU: _List_Nil, cN: _List_Nil, D: _List_Nil, _: 0, g: $elm$core$Set$empty, aD: $elm$core$Maybe$Nothing, aZ: $elm$core$Maybe$Nothing};
var $author$project$Doc$AddCol = F2(
	function (a, b) {
		return {$: 15, a: a, b: b};
	});
...
var $author$project$Doc$AddRow = function (a) {
	return {$: 14, a: a};
};
...
var $author$project$Doc$DelCol = F2(
	function (a, b) {
		return {$: 16, a: a, b: b};
	});
...
var $author$project$Doc$DraftPair = {$: 21};
...
var $author$project$Doc$HideDone = {$: 27};
var $author$project$Doc$Insert = F3(
	function (a, b, c) {
		return {$: 19, a: a, b: b, c: c};
	});
var $author$project$Doc$NameCol = F3(
	function (a, b, c) {
...
var $author$project$Body$Cell = F3(
	function (key, val, colour) {
		return {ch: colour, bB: key, bd: val};
	});
...
var $author$project$Body$Kid = F4(
	function (index, level, line, cells) {
		return {ad: cells, ay: index, W: level, J: line};
	});
										...
										return function (index) {
											return function (level) {
												return function (alone) {
													return {ab: alone, ad: cells, d: from, y: grain, c: id, ay: index, k: kind, W: level, an: name, v: owner, Q: text, h: to, T: was};
												};
											};
										};
									};
...
var $author$project$Scan$Stop = F5(
	function (from, to, grain, name, up) {
		return {d: from, y: grain, an: name, h: to, cY: up};
	});
...
var $author$project$Scan$extentOf = F4(
	function (lines, end, i, kind) {
		switch (kind) {
			...
			case 1:
				return A3($author$project$Scan$listRun, lines, i, end).h;
			case 2:
			...
			return A3(
				...
				_Utils_ap(
					A2(
						$elm$core$List$drop,
						1,
						A2($elm$core$List$map, $elm$core$Tuple$first, run.aO)),
					_List_fromArray(
						[run.h])));
		};
		var go = F2(
					...
					if ($author$project$Scan$isBlank(
						...
						switch (_v0) {
							...
							case 1:
								...
								return A2(
									go,
									A2($elm$core$Basics$max, i + 1, run.h),
									_Utils_ap(
										out,
										items(run)));
							case 2:
		...
		var deeper = F2(
			function (reg, got) {
				return (reg.k === 1) ? A5(
					...
					lines,
					reg.d,
					A3($author$project$Scan$snug, lines, reg.d, reg.h),
	...
	function (lines, own, headCells, kids) {
		var tail = _Utils_update(
			$author$project$Body$blank,
			{
				...
				h: $elm$core$List$length(lines)
			});
		var head = _Utils_update(
			$author$project$Body$blank,
			{ad: headCells, y: 0, c: 'H', k: 0});
		...
		var rowsIn = F5(
			function (prefix, owner, lvl, a, b) {
				...
				return A2(
					...
					F2(
						function (i, b_) {
							var held = A3($author$project$Scan$cut, lines, b_.d, b_.h);
							return _Utils_update(
								$author$project$Body$blank,
								{
									d: b_.d,
		...
		var owned = function (r) {
			...
			return _Utils_eq(stop, r.h) ? r : _Utils_update(
				r,
				{
					Q: A3($author$project$Scan$cut, lines, r.d, stop),
					T: A3($author$project$Scan$cut, lines, r.d, stop)
				});
		};
		var descend = F3(
			function (seen, ks, out) {
				...
				while (true) {
					if (!ks.b) {
						...
						var cid = 'C' + $elm$core$String$fromInt(k.ay);
						var above = A2(
							$elm$core$List$filter,
							function (_v1) {
								var l = _v1.a;
								return _Utils_cmp(l, k.W) < 0;
							},
							seen);
...
var $author$project$Doc$entriesOf = function (m) {
	return A3($author$project$Body$planEntries, m.aU, m.B, m.ax);
};
...
var $author$project$Body$metaRows = function (_v0) {
	...
	var planning = $elm$core$List$isEmpty(entries) ? _List_Nil : _List_fromArray(
		[
			...
			$author$project$Body$blank,
			{
				...
				k: 3,
				Q: $author$project$Body$planningText(entries),
				T: $author$project$Body$planningText(entries)
			})
		]);
	var pair = F2(
		function (i, _v1) {
			...
			return _Utils_update(
				$author$project$Body$blank,
				{
					...
					k: 3,
					v: $elm$core$Maybe$Just($author$project$Body$drawerId),
					Q: $author$project$Body$propertyText(
						_Utils_Tuple2(key, value)),
					T: $author$project$Body$propertyText(
						_Utils_Tuple2(key, value))
				});
		});
	var drawer = _Utils_update(
		$author$project$Body$blank,
		{
			...
			k: 3,
			an: $elm$core$Maybe$Just('properties')
		});
					...
					return A2(
						...
						_Utils_ap(
							$author$project$Body$metaRows(
								{
									cl: m.V,
									cn: $author$project$Doc$entriesOf(m),
									cN: m.cN
								}),
							rest));
				} else {
...
var $author$project$Doc$lineOf = F2(
	function (m, r) {
		return A2(
			$elm$core$Maybe$withDefault,
			'',
			A2($elm$core$Array$get, r.d, m.av));
	});
var $author$project$Doc$drawer = F2(
	function (m, r) {
		return (r.y === 1) && ((r.k === 3) || (!_Utils_eq(
			$author$project$Scan$drawerName(
...
var $author$project$Doc$seedMeta = function (m) {
	...
	return _Utils_update(
		seeded,
		{
			g: $author$project$Doc$seedShut(seeded)
		});
};
			...
			F4(
				function (props, plan, keys, slots) {
					return $author$project$Doc$seedMeta(
						_Utils_update(
							m,
							{B: plan, ao: keys, aU: slots, cN: props}));
				}),
			A2(
				$elm$json$Json$Decode$field,
				'props',
				...
				F8(
					function (lines, own, headCells, kids, links, spanAt, shift, level) {
						var seeded = _Utils_update(
							...
							{
								av: $elm$core$Array$fromList(lines),
								W: level,
								aP: lines,
								aQ: links,
								aC: $author$project$Doc$offsetsOf(lines),
								_: shift,
								aD: spanAt
							});
						return _Utils_update(
							seeded,
							{
								D: A4($author$project$Body$rowsFrom, lines, own, headCells, kids)
							});
					}),
				A2(
					$elm$json$Json$Decode$field,
	...
	function (kind) {
		switch (kind) {
			...
			case 'addrow':
				return A2(
					$elm$json$Json$Decode$map,
					$author$project$Doc$AddRow,
					A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string));
			case 'addcol':
				return A3(
					$elm$json$Json$Decode$map2,
					$author$project$Doc$AddCol,
					A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
					A2($elm$json$Json$Decode$field, 'col', $elm$json$Json$Decode$int));
			case 'delcol':
				return A3(
					$elm$json$Json$Decode$map2,
					$author$project$Doc$DelCol,
					A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
					A2($elm$json$Json$Decode$field, 'col', $elm$json$Json$Decode$int));
			case 'namecol':
				return A4(
					$elm$json$Json$Decode$map3,
					$author$project$Doc$NameCol,
					A2($elm$json$Json$Decode$field, 'id', $elm$json$Json$Decode$string),
					A2($elm$json$Json$Decode$field, 'col', $elm$json$Json$Decode$int),
					A2($elm$json$Json$Decode$field, 'text', $elm$json$Json$Decode$string));
			case 'insert':
...
var $author$project$Scan$closerOpen = function (line) {
	...
	if (!_v0.$) {
		...
		return $elm$core$Maybe$Just(
			{
				...
				aT: $author$project$Scan$verbatim(name),
				g: $author$project$Scan$endsBlock(name)
			});
	} else {
		...
		if (!_v1.$) {
			return $elm$core$Maybe$Just(
				{
					aK: $author$project$Scan$indentOf(line) + ':END:',
					aT: false,
					g: $author$project$Scan$drawerEnds
				});
		} else {
			return $elm$core$Maybe$Nothing;
		}
...
var $author$project$Scan$closerStep = F2(
	function (line, _v0) {
		...
		if (stack.b) {
			var top = stack.a;
			var below = stack.b;
			return top.g(line) ? _Utils_Tuple2(below, false) : (top.aT ? _Utils_Tuple2(stack, false) : A2($author$project$Scan$closerPush, line, stack));
		} else {
...
var $author$project$Body$bodyText = F2(
	function (m, gone) {
			...
			function (r, out) {
				if (A2($elm$core$List$member, r.c, gone)) {
					var spare = ((_Utils_cmp(
						r.h,
						$elm$core$List$length(out) - 1) < 0) && A2($author$project$Scan$blankAt, r.h, out)) ? 1 : 0;
					return _Utils_ap(
						A2($elm$core$List$take, r.d, out),
						A2($elm$core$List$drop, r.h + spare, out));
				} else {
					if (!_Utils_eq(r.Q, r.T)) {
						var typed = A2($elm$core$String$split, '\u000A', r.Q);
						var written = _Utils_ap(
							typed,
							$author$project$Scan$closers(typed));
						var shift = $author$project$Body$indentIn(r.Q) - $author$project$Body$indentIn(r.T);
						var cut = A2($author$project$Body$ownEnd, m.D, r);
						var under = A2(
							$elm$core$List$map,
						...
						return _Utils_ap(
							A2($elm$core$List$take, r.d, out),
							_Utils_ap(
								r.ab ? A3($author$project$Body$apart, out, r.d, written) : written,
								_Utils_ap(
									under,
									A2($elm$core$List$drop, r.h, out))));
					} else {
						return out;
					}
				}
		...
		var moved = function (r) {
			return (r.k === 1) && (A2($elm$core$List$member, r.c, gone) || (!_Utils_eq(r.Q, r.T)));
		};
		var spoken = A2(
			$elm$core$List$map,
			function ($) {
			...
			A2($elm$core$List$filter, moved, m.D));
		...
		var paras = $elm$core$List$reverse(
			A2(
				$elm$core$List$filter,
				function (r) {
					return (r.k === 1) && (!silenced(r));
				},
				m.D));
		return A2(
			$elm$core$String$join,
			'\u000A',
			A3($elm$core$List$foldl, splice, m.aP, paras));
	});
...
var $author$project$Doc$headerJSON = function (m) {
	return _List_fromArray(
		[
			_Utils_Tuple2(
			'properties',
			$author$project$Doc$pairsJSON(m.cN)),
			_Utils_Tuple2(
			'planning',
			$author$project$Doc$pairsJSON(m.B))
		]);
};
	...
	function (m, i) {
		return A2(
			...
			A2(
				...
				A2($author$project$Scan$nth, i, m.D)));
	});
var $author$project$Doc$landAt = F2(
	function (i, m) {
		return _Utils_update(
			m,
			{aI: i, e: $elm$core$Maybe$Nothing, n: false, C: $elm$core$Maybe$Nothing});
	});
	...
	function (model, taken, cut) {
		...
		if (_v0.$ === 1) {
			...
			var kin = A2(
				$elm$core$List$filter,
				function (r) {
					return (r.k === 1) && (_Utils_eq(r.v, first.v) && (!A2(
						$elm$core$List$member,
						r.c,
						A2(
							$elm$core$List$map,
...
var $author$project$Doc$openedLen = A2(
	...
	$elm$core$Maybe$map(
		function (o) {
			return o.bz + $elm$core$String$length(o.aJ);
		}));
...
var $author$project$Doc$openerAt = F2(
	function (m, r) {
		return ((r.y !== 2) || (r.k !== 1)) ? $elm$core$Maybe$Nothing : $author$project$Scan$listOpener(
			A2($author$project$Doc$lineOf, m, r));
	});
...
var $author$project$Doc$hiddenDone = function (m) {
	return $elm$core$Set$isEmpty(m.z) ? $elm$core$Set$empty : $elm$core$Set$fromList(
		A2(
			$elm$core$List$filterMap,
			function (r) {
				if (A2($author$project$Doc$isListRoot, m, r.c)) {
					return (A2($elm$core$Set$member, r.c, m.z) && A2($author$project$Doc$subtreeDone, m, r)) ? $elm$core$Maybe$Just(r.c) : $elm$core$Maybe$Nothing;
				} else {
					...
					if ((!_v0.a.$) && (!_v0.b.$)) {
						var root = _v0.b.a;
						return (A2($elm$core$Set$member, root, m.z) && A2($author$project$Doc$subtreeDone, m, r)) ? $elm$core$Maybe$Just(r.c) : $elm$core$Maybe$Nothing;
					} else {
						return $elm$core$Maybe$Nothing;
					}
				}
	...
	return A3(
		...
		F2(
			function (r, acc) {
				...
				if (!_v0.$) {
					var o = _v0.a;
					return (A2($elm$core$Set$member, o, m.g) || A2($elm$core$Set$member, o, acc)) ? A2($elm$core$Set$insert, r.c, acc) : acc;
				} else {
					return acc;
				}
			}),
...
var $author$project$Doc$snapVisible = function (m) {
	...
	var landing = (A2(seek, 1, m.aI) >= 0) ? A2(seek, 1, m.aI) : A2(seek, -1, m.aI);
	return (A2(
		$elm$core$Set$member,
		A2($author$project$Doc$idAtRow, m, m.aI),
...
var $author$project$Body$rowAt = function (m) {
	return A2($author$project$Scan$nth, m.aI, m.D);
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'key',
				$elm$json$Json$Encode$string(c.bB)),
				_Utils_Tuple2(
				'val',
				$elm$json$Json$Encode$string(c.bd)),
				_Utils_Tuple2(
				'colour',
				$elm$json$Json$Encode$string(c.ch))
			]));
};
var $author$project$Doc$charOf = F2(
	function (m, line) {
		return A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Array$get, line, m.aC));
	});
			...
			switch (_v1) {
				...
				case 1:
					return _Utils_eq(r.c, $author$project$Body$tailId) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
						_Utils_Tuple2(
							(base + m._) + A2($author$project$Doc$charOf, m, r.d),
							(base + m._) + A2($author$project$Doc$charOf, m, r.h)));
				default:
					return $elm$core$Maybe$Just(
						_Utils_Tuple2(
							base,
...
var $author$project$Doc$foldable = F2(
	function (m, r) {
		return (r.k === 2) || A2($author$project$Doc$drawer, m, r);
	});
...
var $author$project$Doc$reachSpan = F2(
	function (m, r) {
		var _v0 = _Utils_Tuple2(m.aD, r.k);
		_v0$2:
		while (true) {
			if (!_v0.a.$) {
				switch (_v0.b) {
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					...
					'kind',
					$elm$json$Json$Encode$string(
						$author$project$Body$kindWord(r.k))),
					_Utils_Tuple2(
					'fold',
					...
					A2(
						$elm$core$Maybe$withDefault,
						$elm$json$Json$Encode$null,
						A2($elm$core$Maybe$map, $elm$json$Json$Encode$string, r.an))),
					_Utils_Tuple2(
					'owner',
					A2(
						$elm$core$Maybe$withDefault,
						$elm$json$Json$Encode$null,
						A2($elm$core$Maybe$map, $elm$json$Json$Encode$string, r.v))),
					_Utils_Tuple2(
					'from',
					$elm$json$Json$Encode$int(r.d)),
					_Utils_Tuple2(
					'to',
					$elm$json$Json$Encode$int(r.h)),
					_Utils_Tuple2(
					'text',
					$elm$json$Json$Encode$string(r.Q)),
					_Utils_Tuple2(
					'index',
					$elm$json$Json$Encode$int(r.ay)),
					_Utils_Tuple2(
					'level',
					$elm$json$Json$Encode$int(r.W)),
					_Utils_Tuple2(
					'cells',
...
var $author$project$Doc$tableHasHeader = F2(
	function (m, comp) {
		...
		if (_v0.b && _v0.b.b) {
			var _v1 = _v0.b;
			var second = _v1.a;
			return $author$project$Body$isRule(second.Q);
		} else {
			return false;
		}
	});
...
var $author$project$Doc$tableHeadCompOf = F2(
	function (m, r) {
		var _v0 = A2(
			$elm$core$Maybe$andThen,
		...
		if (!_v0.$) {
			...
			if (!_Utils_eq(
				...
				var _v1 = A2($author$project$Doc$tableHeadRow, m, comp);
				if (!_v1.$) {
					var h = _v1.a;
					return _Utils_eq(h.c, r.c) ? $elm$core$Maybe$Just(comp) : $elm$core$Maybe$Nothing;
				} else {
					return $elm$core$Maybe$Nothing;
				}
			}
...
var $author$project$Doc$tableHeadAt = function (m) {
	return A2(
		$elm$core$Maybe$andThen,
		$author$project$Doc$tableHeadCompOf(m),
			...
			_List_fromArray(
				[
					...
					A2(
						$elm$core$Maybe$withDefault,
						$elm$json$Json$Encode$null,
						A2($elm$core$Maybe$map, $elm$json$Json$Encode$int, m.e))),
					_Utils_Tuple2(
					'head',
					$elm$json$Json$Encode$bool(
						!_Utils_eq(
							$author$project$Doc$tableHeadAt(m),
							$elm$core$Maybe$Nothing))),
					_Utils_Tuple2(
					'ephem',
					$elm$json$Json$Encode$bool(m.n)),
					_Utils_Tuple2(
					'flags',
					A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, m.R)),
					_Utils_Tuple2(
	...
	function (ids, model) {
		...
		var keptProps = A2($elm$core$List$member, $author$project$Body$drawerId, ids) ? _List_Nil : A2(
			...
			A2(
				...
				A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, model.cN)));
		var keptPlan = A2($elm$core$List$member, $author$project$Body$planId, ids) ? _List_Nil : model.B;
		var model_ = $author$project$Doc$remeta(
			_Utils_update(
				model,
				{B: keptPlan, cN: keptProps}));
		var cut = $elm$core$List$length(model.aP) - $elm$core$List$length(
			A2($elm$core$String$split, '\u000A', written));
		var landsOn = A3($author$project$Doc$landingAfter, model, taken, cut);
		var done = A2(
			$author$project$Doc$landOn,
			A2($author$project$Doc$idAtRow, model, model.aI),
			_Utils_update(
				model_,
				{L: landsOn}));
...
var $author$project$Body$placeAtLine = F2(
	function (m, line) {
		var stops = A2(
			...
			A2($elm$core$List$indexedMap, $elm$core$Tuple$pair, m.D));
		...
		var covering = A3(
			...
			F2(
				function (_v6, held) {
					var i = _v6.a;
					var r = _v6.b;
					return ((_Utils_cmp(r.d, line) < 1) && (_Utils_cmp(line, r.h) < 0)) ? $elm$core$Maybe$Just(i) : held;
				}),
			$elm$core$Maybe$Nothing,
			stops);
	...
	function (m, line) {
		return A2(
			...
			A2(
				$author$project$Scan$indexWhere,
				function (r) {
					return (r.k === 1) && _Utils_eq(r.d, line);
				},
				m.D));
	});
var $author$project$Doc$fillLanding = F2(
	function (fresh, model) {
		var _v0 = _Utils_Tuple2(fresh.L, model.L);
		if (!_v0.a.$) {
			var line = _v0.a.a;
...
var $author$project$Doc$atFirstBody = F2(
	function (m, comp) {
...
var $author$project$Doc$headerlessFirst = function (m) {
	var _v0 = $author$project$Doc$tableCompAt(m);
	if (!_v0.$) {
		var comp = _v0.a;
		return ((!A2($author$project$Doc$tableHasHeader, m, comp)) && A2($author$project$Doc$atFirstBody, m, comp)) ? $elm$core$Maybe$Just(comp) : $elm$core$Maybe$Nothing;
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
var $author$project$Doc$tableCellCompOf = F2(
	function (m, r) {
		var _v0 = A2($author$project$Doc$tableCompOf, m, r);
		if (!_v0.$) {
			var comp = _v0.a;
			return $elm$core$Maybe$Just(comp);
		} else {
			return A2($author$project$Doc$tableHeadCompOf, m, r);
		}
	});
var $author$project$Doc$inTableAt = function (m) {
	return !_Utils_eq(
		A2(
			$elm$core$Maybe$andThen,
			$author$project$Doc$tableCellCompOf(m),
			$author$project$Body$rowAt(m)),
		$elm$core$Maybe$Nothing);
};
var $author$project$Doc$settled = function (m) {
	var keptPlan = _Utils_eq(
		A2($author$project$Doc$idAtRow, m, m.aI),
		$author$project$Body$planId) ? m.C : $elm$core$Maybe$Nothing;
	var keptEphem = m.n && (!_Utils_eq(
		$author$project$Doc$headerlessFirst(m),
		$elm$core$Maybe$Nothing));
	var keptCol = $author$project$Doc$inTableAt(m) ? m.e : $elm$core$Maybe$Nothing;
	return $author$project$Doc$snapVisible(
		_Utils_update(
			m,
			{e: keptCol, n: keptEphem, C: keptPlan}));
};
			...
			$author$project$Doc$reveal(
				$author$project$Doc$snapVisible(
					_Utils_update(
						fresh,
						{
							aI: A2($author$project$Doc$fillLanding, fresh, model),
							e: model.e,
							n: model.n,
							z: A2(
	...
	function (id, m) {
		...
		return $author$project$Doc$told(
			_Utils_update(
				fresh,
				{
					aI: A2($author$project$Body$placeOf, fresh, id)
				}));
	});
			...
			if (!_v3.$) {
				...
				var word = function () {
					...
					if (!_v4.$) {
						...
						return (up.y === 2) ? 'item' : $author$project$Body$kindWord(up.k);
					}
				}();
				return _Utils_Tuple2(
					_Utils_update(
				...
				return (!r.k) ? _Utils_Tuple2(m, 'grain-broader (the whole entry)') : _Utils_Tuple2(
					_Utils_update(
						m,
						{
							aI: A2($author$project$Body$placeOf, m, 'H')
						}),
...
var $author$project$Body$Join = F6(
	function (under, line, marker, owner, alone, word) {
		return {ab: alone, J: line, aS: marker, v: owner, bc: under, b4: word};
	});
var $author$project$Body$caretLine = F2(
	function (r, off) {
		return r.d + A3(
			...
			0,
			A2($elm$core$Basics$max, 0, (r.h - r.d) - 1),
			off);
	});
	...
	function (m, r, line) {
		return A3(
			...
			A2(
				$elm$core$List$filter,
				function (s) {
					return (s.k === 1) && ((!_Utils_eq(s.c, $author$project$Body$draftId)) && ((_Utils_cmp(s.d, line) < 1) && ((_Utils_cmp(line, s.h) < 0) && A2(
						$elm$core$List$member,
						r.c,
...
var $author$project$Body$anchored = F5(
	function (m, r, line, marker, word) {
		...
		return A6(
			...
			line,
			marker,
			(_Utils_cmp(line, host.h) > -1) ? host.v : $elm$core$Maybe$Just(host.c),
			false,
			word);
	});
var $author$project$Scan$closerAt = F2(
	function (reg, line) {
		return $author$project$Scan$closes(reg.k) && _Utils_eq(line, reg.h - 1);
	});
...
var $elm$core$Array$appendHelpBuilder = F2(
	function (tail, builder) {
		...
		} : {q: builder.q, l: builder.l, p: appended});
	});
	...
	function (lines, reg) {
		...
		switch (_v0) {
			...
			case 2:
				return _Utils_ap(
					indent,
					A3($author$project$Body$tableRow, lines, reg.d, reg.h));
			case 3:
				return indent;
			default:
				return indent;
...
var $author$project$Body$pastWord = function (top) {
	...
	if (!_v0.$) {
		...
		return (top.y === 1) ? 'after the block' : 'after this paragraph';
	}
};
...
var $author$project$Scan$interiorEnd = function (reg) {
	return $author$project$Scan$closes(reg.k) ? (reg.h - 1) : reg.h;
};
var $author$project$Scan$regionAt = F4(
	function (lines, from, end, line) {
		var _v0 = A2(
			$elm$core$List$filter,
			function (r) {
				return (_Utils_cmp(r.d, line) < 1) && (_Utils_cmp(line, r.h) < 0);
			},
...
var $author$project$Scan$within = F3(
	function (lines, reg, line) {
		var nested = A4(
			...
			line);
		return ((!nested.k) || A2($author$project$Scan$closerAt, nested, line)) ? reg : nested;
	});
...
var $author$project$Body$inside = F3(
	function (m, r, line) {
		...
		var lines = $elm$core$Array$fromList(m.aP);
		var reg = A4($author$project$Scan$regionAt, lines, top.d, top.h, line);
		return ((!reg.k) || A2($author$project$Scan$closerAt, reg, line)) ? A6(
			$author$project$Body$Join,
			top.c,
			reg.h,
			'',
			...
			$author$project$Body$regionWord(reg.k));
	});
var $author$project$Body$sibling = F2(
	function (m, r) {
		...
		return (_Utils_eq(
			top.an,
			$elm$core$Maybe$Just('list')) && (r.y === 2)) ? A6(
			$author$project$Body$Join,
			r.c,
			r.h,
			A2(
				$author$project$Body$itemMarker,
				$elm$core$Array$fromList(m.aP),
				r.d),
			r.v,
			false,
		...
		return A2(
			...
			function (j) {
				return A3(
					...
					m,
					j.bc,
					A2($author$project$Body$draftRow, j, j.aS));
			},
		...
		if (_Utils_eq(id, $author$project$Body$planId)) {
			return A2(
				...
				$author$project$Doc$remeta(
					_Utils_update(
						m,
						{
							B: A2($author$project$Body$readPlanning, m.ao, written)
						})));
		} else {
			var _v0 = _Utils_Tuple2(
			...
			if ((!_v0.a.$) && (!_v0.b.$)) {
				...
				var pairsWith = function (now) {
					return _Utils_ap(
						A2($elm$core$List$take, i, m.cN),
						_Utils_ap(
							now,
							A2($elm$core$List$drop, i + 1, m.cN)));
				};
				var _v2 = A2($author$project$Body$planningKey, m.ao, key);
				if (!_v2.$) {
					var word = _v2.a;
					return A2(
...
var $author$project$Doc$planFiner = function (m) {
	var want = 1 + A2($elm$core$Maybe$withDefault, -1, m.C);
	var entries = $author$project$Doc$entriesOf(m);
		...
		if (!_v0.$) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					m,
					{
						aI: A2($author$project$Body$placeOf, m, first.c),
				...
				if (!_v1.$) {
					...
					return $author$project$Doc$heading(r) ? (entered ? _Utils_Tuple2(
						...
						A4(
							$author$project$Doc$grainWord,
							'grain-finer',
							A2($elm$core$Maybe$withDefault, 'item', r.an),
							1,
							kids)) : ((r.y === 2) ? _Utils_Tuple2(m, 'grain-finer (at the finest)') : _Utils_Tuple2(m, 'grain-finer (nothing finer here)')));
				}
			}
		}
	}
...
var $author$project$Doc$foldAt = F2(
	function (r, m) {
		var opened = A2($elm$core$Set$member, r.c, m.g);
		return _Utils_Tuple2(
			_Utils_update(
				m,
				{
					aI: A2($author$project$Body$placeOf, m, r.c),
					g: opened ? A2($elm$core$Set$remove, r.c, m.g) : A2($elm$core$Set$insert, r.c, m.g)
				}),
			'org-cycle (' + (((r.k === 2) ? 'subtree' : A2($elm$core$Maybe$withDefault, 'drawer', r.an)) + (opened ? ' open)' : ' folded)')));
	});
var $author$project$Doc$foldTarget = function (m) {
	var here = A2($author$project$Doc$idAtRow, m, m.aI);
	var ups = A2(
		$elm$core$List$filter,
		function (o) {
			return !_Utils_eq(
...
var $author$project$Doc$raggedRow = F2(
	function (indent, cells) {
		return indent + ('| ' + (A2($elm$core$String$join, ' | ', cells) + ' |'));
	});
var $author$project$Doc$insertCol = F2(
	function (col, line) {
		if ($author$project$Body$isRule(line)) {
			return line;
		} else {
			var cells = A2(
				$elm$core$List$map,
				$elm$core$String$trim,
				$author$project$Body$tableCells(line));
			var widened = _Utils_ap(
				A2($elm$core$List$take, col + 1, cells),
				_Utils_ap(
					_List_fromArray(
						['']),
					A2($elm$core$List$drop, col + 1, cells)));
			return A2(
				$author$project$Doc$raggedRow,
				$author$project$Scan$indentOf(line),
				widened);
		}
	});
...
var $author$project$Body$joinLine = F3(
	function (m, id, caret) {
		return A2(
			$elm$core$Maybe$map,
			function (j) {
				return (j.ab && ((j.J > 1) && (!A2($author$project$Scan$blankAt, j.J - 1, m.aP)))) ? (j.J + 1) : j.J;
			},
			A3($author$project$Body$joinAt, m, id, caret));
	});
...
var $author$project$Doc$narrowed = F2(
	function (m, text) {
		var deepen = function (line) {
			var n = $author$project$Doc$starsAt(line);
			return ((n > 0) && ((_Utils_cmp(n, m.W) < 1) && $author$project$Doc$headlineAt(line))) ? _Utils_ap(
				A2($elm$core$String$repeat, m.W + 1, '*'),
...
var $author$project$Doc$nextVisible = F2(
	function (by, m) {
		var total = $elm$core$List$length(m.D);
		var gone = A2(
			$elm$core$Set$union,
			$author$project$Doc$hiddenDone(m),
			$author$project$Doc$hiddenIn(m));
...
var $author$project$Doc$removeCol = F2(
	function (col, line) {
		if ($author$project$Body$isRule(line)) {
			return line;
		} else {
			...
			return A2(
				...
				$author$project$Scan$indentOf(line),
				_Utils_ap(
					A2($elm$core$List$take, col, cells),
					A2($elm$core$List$drop, col + 1, cells)));
		}
	});
		...
		return _Utils_Tuple2(
			...
			function () {
				var _v0 = A2(
					$elm$core$List$filter,
					function (k) {
						return (k.k === 2) && ((_Utils_cmp(k.d, r.d) > 0) && (_Utils_cmp(k.W, r.W) < 1));
					},
					m.D);
				if (_v0.b) {
					var next = _v0.a;
					...
					return $elm$core$List$length(m.aP);
				}
			}());
	});
		...
		if (_v0.$ === 1) {
			...
			if (!r.k) {
				...
				if (r.k !== 2) {
					...
					if ((by < 0) && (_Utils_cmp(r.W, m.W + 1) < 1)) {
						...
						var deepen = function (k) {
							return ((_Utils_cmp(k.d, from) > -1) && ((_Utils_cmp(k.d, to) < 0) && ((k.k === 2) || (k.k === 1)))) ? _Utils_update(
								k,
								{W: k.W + by}) : k;
						};
						var fresh = A3(
						...
						return A2(
							$author$project$Doc$composedWith,
							$elm$core$Maybe$Just(
								word + (' (level ' + ($elm$core$String$fromInt(r.W + by) + ')'))),
							_Utils_update(
								m,
								{
									av: $elm$core$Array$fromList(fresh),
									aP: fresh,
									aC: $author$project$Doc$offsetsOf(fresh),
									D: A2($elm$core$List$map, deepen, m.D)
								}));
					}
				}
			}
			...
			var cohort = function () {
				if (cur.k === 2) {
					...
					if ((by < 0) && A2($author$project$Doc$shelved, m, cur)) {
						var hidden = $author$project$Doc$hiddenIn(m);
						return function (r) {
							return (_Utils_eq(r.v, cur.v) || $author$project$Doc$heading(r)) && (!A2($elm$core$Set$member, r.c, hidden));
						};
					} else {
						return function (r) {
							return _Utils_eq(r.v, cur.v);
						};
					}
				}
			}();
		...
		if (!_v0.$) {
			...
			return _Utils_Tuple2(
				_Utils_update(
					m,
					{
						aI: A2($author$project$Body$placeOf, m, comp.c),
						e: $elm$core$Maybe$Nothing
					}),
				'grain-broader (the table)');
		}
	});
var $author$project$Doc$tableHeadBroader = function (m) {
	var _v0 = m.e;
	if (!_v0.$) {
		var i = _v0.a;
		return (i > 0) ? _Utils_Tuple2(
			...
			'grain-broader (column)') : _Utils_Tuple2(m, 'grain-broader (the first column)');
	} else {
		return _Utils_Tuple2(m, 'grain-broader (the header)');
	}
};
	...
	function (by, m, comp) {
		...
		if (!_v0.$) {
			...
			return _Utils_update(
				m,
				{
					aI: A2($author$project$Body$placeOf, m, target.c)
				});
		} else {
			return m;
		}
	});
var $author$project$Doc$toFirstBody = F2(
	function (m, comp) {
		var _v0 = $elm$core$List$head(
			A2($author$project$Doc$tableBodyRows, m, comp));
		if (!_v0.$) {
			...
			return _Utils_Tuple2(m, 'next-row');
		}
	});
var $author$project$Doc$toHeader = F2(
	function (m, comp) {
		var _v0 = A2($author$project$Doc$tableHeadRow, m, comp);
		if (!_v0.$) {
			var h = _v0.a;
			return _Utils_Tuple2(
				_Utils_update(
					m,
					{
						aI: A2($author$project$Body$placeOf, m, h.c)
					}),
				'grain-broader (the header)');
		} else {
			return _Utils_Tuple2(m, 'grain-broader (no header)');
		}
	});
		...
		switch (msg.$) {
			...
			case 4:
				...
				if (model.n) {
					...
					if (!_v2.$) {
						var comp = _v2.a;
						return (by > 0) ? $author$project$Doc$spoke(
							_Utils_Tuple2(
								_Utils_update(
									model,
									{n: false}),
								'next-row')) : $author$project$Doc$spoke(
							_Utils_Tuple2(
								_Utils_update(
									model,
									{
										aI: A2($author$project$Body$placeOf, model, comp.c),
										e: $elm$core$Maybe$Nothing,
										n: false
									}),
								'previous-row'));
					...
					var _v3 = $author$project$Doc$tableCompAt(model);
					if (!_v3.$) {
						var comp = _v3.a;
						return ((by < 0) && (A2($author$project$Doc$atFirstBody, model, comp) && (!_Utils_eq(model.e, $elm$core$Maybe$Nothing)))) ? (A2($author$project$Doc$tableHasHeader, model, comp) ? $author$project$Doc$spoke(
							A2($author$project$Doc$toHeader, model, comp)) : $author$project$Doc$spoke(
							_Utils_Tuple2(
								_Utils_update(
									model,
									{n: true}),
								'grain-broader (the header)'))) : $author$project$Doc$spoke(
							_Utils_Tuple2(
								A3($author$project$Doc$tableStep, by, model, comp),
								(by > 0) ? 'next-row' : 'previous-row'));
					} else {
						var _v4 = $author$project$Doc$tableHeadAt(model);
						if (!_v4.$) {
							var comp = _v4.a;
							return (by > 0) ? $author$project$Doc$spoke(
								A2($author$project$Doc$toFirstBody, model, comp)) : $author$project$Doc$spoke(
								_Utils_Tuple2(
									_Utils_update(
										model,
										{
			...
			case 5:
				var opened = function () {
					var _v6 = $author$project$Body$rowAt(model);
					if (!_v6.$) {
						var r = _v6.a;
						return A2($author$project$Doc$foldable, model, r) ? _Utils_update(
							model,
							{
								g: A2($elm$core$Set$remove, r.c, model.g)
							}) : model;
					} else {
						return model;
					}
				}();
				var _v5 = $author$project$Doc$finer(opened);
				var fined = _v5.a;
				var word = _v5.b;
				return $author$project$Doc$inTableAt(model) ? $author$project$Doc$spoke(
					_Utils_Tuple2(fined, word)) : ((_Utils_eq(fined.aI, model.aI) && (_Utils_eq(fined.C, model.C) && (_Utils_eq(fined.e, model.e) && _Utils_eq(fined.g, model.g)))) ? $author$project$Doc$spoke(
					_Utils_Tuple2(
			...
			case 6:
				if (model.n) {
					return $author$project$Doc$spoke(
						$author$project$Doc$tableHeadBroader(model));
				} else {
					var _v7 = $author$project$Doc$tableCompAt(model);
					if (!_v7.$) {
						var comp = _v7.a;
						return $author$project$Doc$spoke(
							A2($author$project$Doc$tableBroader, model, comp));
					} else {
						var _v8 = $author$project$Doc$tableHeadAt(model);
						if (!_v8.$) {
							return $author$project$Doc$spoke(
								$author$project$Doc$tableHeadBroader(model));
						} else {
			...
			case 27:
				var scoped = function () {
					var _v11 = $author$project$Body$rowAt(model);
					if (!_v11.$) {
						var r = _v11.a;
				...
				var next = function () {
					if (!scoped.$) {
						var root = scoped.a;
						return A2($elm$core$Set$member, root, model.z) ? A2($elm$core$Set$remove, root, model.z) : A2($elm$core$Set$insert, root, model.z);
					} else {
						return $elm$core$Set$isEmpty(model.z) ? $elm$core$Set$fromList(
				...
				return $author$project$Doc$spoke(
					_Utils_Tuple2(
						...
						word));
			case 25:
				var _v12 = $author$project$Doc$foldTarget(model);
				if (_v12.$ === 1) {
					return $author$project$Doc$spoke(
			...
			case 26:
				var id = msg.a;
				var _v13 = A2($author$project$Body$rowById, model, id);
				if (_v13.$ === 1) {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				} else {
					var r = _v13.a;
			...
			case 29:
				var key = msg.a;
				var value = msg.b;
				var _v14 = A2($author$project$Body$planningKey, model.ao, key);
				if (!_v14.$) {
					var word = _v14.a;
					return A2(
						$author$project$Doc$composedWith,
								...
								fresh,
								{
									aI: A2(
										...
										$author$project$Body$propId(
											$elm$core$List$length(model.cN))),
									g: A2($elm$core$Set$remove, $author$project$Body$drawerId, fresh.g)
								}));
					}
				}
			case 11:
				...
				if (_Utils_eq(
					...
					var write = function (r) {
						return _Utils_eq(r.c, id) ? _Utils_update(
							r,
							{
								Q: A2($author$project$Doc$narrowed, model, written)
							}) : r;
					};
					return $author$project$Doc$composed(
						_Utils_update(
							model,
							{
								D: A2($elm$core$List$map, write, model.D)
							}));
				}
			case 13:
				var id = msg.a;
				...
				var write = function (r) {
					return _Utils_eq(r.c, id) ? _Utils_update(
						r,
						{
							Q: A3($author$project$Doc$replaceCell, col, written, r.Q)
						}) : r;
				};
				return $author$project$Doc$composed(
					_Utils_update(
			...
			case 14:
				...
				var _v15 = A2(
					$elm$core$Maybe$andThen,
					$author$project$Doc$tableCompOf(model),
					A2($author$project$Body$rowById, model, id));
				if (!_v15.$) {
					var comp = _v15.a;
					var blank = A2(
						...
						A2(
							$elm$core$List$repeat,
							A2($author$project$Doc$tableColCount, model, comp),
							''));
					...
					if (!_v16.a.$) {
						...
						return _Utils_Tuple2(
							model,
							$author$project$Doc$docSaid(
								$elm$json$Json$Encode$string('nothing takes a row here')));
					}
				} else {
					return _Utils_Tuple2(
						model,
						$author$project$Doc$docSaid(
							$elm$json$Json$Encode$string('no table row here')));
				}
			case 15:
				var id = msg.a;
				var col = msg.b;
				var _v18 = A2(
					$elm$core$Maybe$andThen,
					$author$project$Doc$tableCellCompOf(model),
					A2($author$project$Body$rowById, model, id));
				if (!_v18.$) {
					var comp = _v18.a;
					var widen = function (r) {
						return _Utils_eq(
							r.v,
							$elm$core$Maybe$Just(comp.c)) ? _Utils_update(
							r,
							{
								Q: A2($author$project$Doc$insertCol, col, r.Q)
							}) : r;
					};
					return $author$project$Doc$composed(
						_Utils_update(
							model,
							{
								e: $elm$core$Maybe$Just(col + 1),
								D: A2($elm$core$List$map, widen, model.D)
							}));
				} else {
					return _Utils_Tuple2(
						model,
						$author$project$Doc$docSaid(
							$elm$json$Json$Encode$string('no table column to add here')));
				}
			case 16:
				var id = msg.a;
				var col = msg.b;
				...
				if (!_v19.$) {
					var comp = _v19.a;
					if (A2($author$project$Doc$tableColCount, model, comp) <= 1) {
						return _Utils_Tuple2(
							model,
							$author$project$Doc$docSaid(
								$elm$json$Json$Encode$string('the table\u0027s last column stands')));
					} else {
						var narrow = function (r) {
							return _Utils_eq(
								r.v,
								$elm$core$Maybe$Just(comp.c)) ? _Utils_update(
								r,
								{
									Q: A2($author$project$Doc$removeCol, col, r.Q)
								}) : r;
						};
						return $author$project$Doc$composed(
							_Utils_update(
								model,
								{
									e: $elm$core$Maybe$Just(
										A2(
											$elm$core$Basics$min,
											col,
											A2($author$project$Doc$tableColCount, model, comp) - 2)),
									D: A2($elm$core$List$map, narrow, model.D)
								}));
					}
				} else {
					return _Utils_Tuple2(
						model,
						$author$project$Doc$docSaid(
							$elm$json$Json$Encode$string('no table column to delete here')));
				}
			case 17:
				var id = msg.a;
				var col = msg.b;
				...
				if (!_v20.a.$) {
					...
					if (name === '') {
						return _Utils_Tuple2(
							_Utils_update(
								...
								{n: false}),
							$author$project$Doc$docSaid(
								$elm$json$Json$Encode$string('nothing named')));
					} else {
						var _v21 = A2($author$project$Doc$tableCompOf, model, r);
						if (!_v21.$) {
							var comp = _v21.a;
							var ncols = A2($author$project$Doc$tableColCount, model, comp);
							var indent = $author$project$Scan$indentOf(r.Q);
							var hline = indent + ('|' + (A2(
								$elm$core$String$join,
								'+',
								A2($elm$core$List$repeat, ncols, '---')) + '|'));
							var headCells = A2(
								$elm$core$List$map,
								function (i) {
									return _Utils_eq(i, col) ? name : '';
								},
								A2($elm$core$List$range, 0, ncols - 1));
							var headerLine = A2($author$project$Doc$raggedRow, indent, headCells);
							var prepend = function (row) {
								return _Utils_eq(row.c, id) ? _Utils_update(
									row,
									{Q: headerLine + ('\u000A' + (hline + ('\u000A' + row.Q)))}) : row;
							};
							return $author$project$Doc$composed(
								_Utils_update(
									...
									{
										n: false,
										D: A2($elm$core$List$map, prepend, model.D)
									}));
						} else {
							return _Utils_Tuple2(
								_Utils_update(
									...
									{n: false}),
								$author$project$Doc$docSaid(
									$elm$json$Json$Encode$string('no headerless table here')));
						}
					}
				} else {
					var _v22 = _v20.a;
					return _Utils_Tuple2(
						_Utils_update(
							...
							{n: false}),
						$author$project$Doc$docSaid(
							$elm$json$Json$Encode$string('no row here')));
				}
			case 18:
				var id = msg.a;
				var caret = msg.b;
			...
			case 21:
				...
				return $author$project$Doc$told(
					_Utils_update(
						fresh,
						{
							aI: A2($author$project$Body$placeOf, fresh, $author$project$Body$draftPairId),
							g: A2($elm$core$Set$remove, $author$project$Body$drawerId, fresh.g)
						}));
			case 22:
				var id = msg.a;
	...
	function (m, r) {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					A2($elm$core$Set$member, r.c, m.g) ? '+' : '\u2212')
				]));
	});
...
var $author$project$Doc$tableView = F2(
	function (m, r) {
		var kids = A2($author$project$Doc$tableKids, m, r);
		...
		var rowVal = function (k) {
			var cs = $author$project$Body$tableCells(k.Q);
			var cell = function (i) {
				return _Utils_Tuple2(
		...
		var bodyRows = hasHeader ? A2($elm$core$List$drop, 1, dataKids) : dataKids;
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					...
					_Utils_Tuple2(
					'rows',
					A2($elm$json$Json$Encode$list, rowVal, bodyRows)),
					_Utils_Tuple2(
					'hasHeader',
...
var $author$project$Doc$stars = F2(
	function (m, level) {
		return A2(
			$elm$core$String$repeat,
			A2($elm$core$Basics$max, 0, 2 * (level - m.W)),
			' ') + '* ';
	});
...
var $author$project$Doc$inset = F2(
	function (m, r) {
		return (_Utils_cmp(r.W, m.W) > 0) ? _List_fromArray(
			[
				A2(
				...
				'--g-doc-indent:' + ($elm$core$String$fromInt(
					$elm$core$String$length(
						A2($author$project$Doc$stars, m, r.W))) + (';' + A2($author$project$Doc$rail, m, r.W))))
			]) : _List_Nil;
	});
var $author$project$Doc$litOf = function (m) {
	return {
		aM: $author$project$Doc$hiddenDone(m),
		a5: $elm$core$Set$fromList(
			A2(
				$elm$core$List$filterMap,
				function ($) {
					return $.v;
...
var $author$project$Doc$compactedRun = F3(
	function (m, done, r) {
		return A2($author$project$Doc$isListRoot, m, r.c) && (A2($elm$core$Set$member, r.c, m.z) && ((!A2($elm$core$Set$member, r.c, done)) && A2(
			$elm$core$List$any,
			function (h) {
				return _Utils_eq(
...
var $author$project$Doc$markOf = F4(
	function (lit, m, i, r) {
		return _Utils_eq(i, m.aI) ? '' : (A2($elm$core$List$member, r.c, lit.a$) ? (' up up-' + $elm$core$String$fromInt(
			A2(
				$elm$core$Basics$min,
				2,
				A2(
					$elm$core$Maybe$withDefault,
					0,
					A2($author$project$Doc$indexOfIn, r.c, lit.a$))))) : (((!_Utils_eq(r.v, $elm$core$Maybe$Nothing)) && _Utils_eq(r.v, lit.a8)) ? ' sib' : ''));
	});
		...
		return _Utils_ap(
			...
			_Utils_ap(
				function () {
					...
					switch (_v0) {
						case 2:
							return (r.k === 3) ? 'meta' : 'item';
						case 1:
							return 'comp d-' + A2($elm$core$Maybe$withDefault, '', r.an);
						default:
							return $author$project$Body$kindWord(r.k);
					}
				}(),
				_Utils_ap(
					_Utils_eq(i, m.aI) ? ' dat' : '',
					_Utils_ap(
						A2($elm$core$List$member, r.c, m.R) ? ' dfl' : '',
						_Utils_ap(
							top ? ' lvl-top' : '',
							_Utils_ap(
								_Utils_eq(r.c, $author$project$Body$tailId) ? ' d-tail' : '',
								_Utils_ap(
									A2($elm$core$Set$member, r.c, lit.aM) ? ' d-hidden' : '',
									_Utils_ap(
										A3($author$project$Doc$compactedRun, m, lit.aM, r) ? ' d-compacted' : '',
										_Utils_ap(
											A2($author$project$Doc$drawer, m, r) ? (A2($elm$core$Set$member, r.c, lit.a5) ? ' d-drawer' : ' d-drawer bare') : '',
...
var $author$project$Doc$drawText = F3(
	function (m, body, base) {
		...
		var inside = function (l) {
			return (_Utils_cmp(l.d, base) > -1) && (_Utils_cmp(l.h, base + n) < 1);
		};
		var go = F3(
		...
		return A3(
			go,
			A2($elm$core$List$filter, inside, m.aQ),
			0,
			_List_Nil);
	});
...
var $author$project$Doc$drawnCells = function (r) {
	return (!r.k) ? A2(
		$elm$core$List$filter,
		function (c) {
			return (c.bd !== '') || (c.bB === 'title');
		},
		r.ad) : $author$project$Body$shown(r);
};
				...
				F2(
					function (j, c) {
						return A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('dc dc-' + c.bB),
									A2($elm$html$Html$Attributes$style, 'color', c.ch)
								]),
							function () {
								var _v0 = _Utils_Tuple3(c.bB, r.k, m.aZ);
								_v0$2:
								while (true) {
									if (_v0.a === 'title') {
										switch (_v0.b) {
											case 0:
												if (!_v0.c.$) {
													var _v1 = _v0.b;
													var t = _v0.c.a;
													return A3($author$project$Doc$drawText, m, c.bd, t);
												} else {
													break _v0$2;
												}
											case 2:
												...
												return A2(
													$elm$core$List$cons,
													$elm$html$Html$text(c.bd),
													A2($elm$core$Set$member, r.c, m.g) ? _List_fromArray(
														[
															A2(
															$elm$html$Html$span,
															_List_fromArray(
...
var $author$project$Doc$keyOf = function (r) {
	return ((r.k === 3) && (r.y === 2)) ? A2(
		$elm$core$Maybe$map,
		$elm$core$Tuple$first,
		$author$project$Body$readProperty(r.Q)) : $elm$core$Maybe$Nothing;
};
	...
	function (op, head) {
		if (!op.$) {
			...
			var tok = A3(
				$elm$core$String$slice,
				o.bz,
				o.bz + $elm$core$String$length(
					$elm$core$String$trimRight(o.aJ)),
				head);
			return $author$project$Doc$stepsAside(tok) ? _List_fromArray(
				[
					$elm$html$Html$text(
					A2($elm$core$String$left, o.bz, head)),
					A2(
					$elm$html$Html$span,
					_List_fromArray(
						[
					...
					A2(
						$elm$core$String$dropLeft,
						o.bz + $elm$core$String$length(tok),
						head))
				]) : _List_fromArray(
				[
...
var $author$project$Doc$viewPara = F2(
	function (m, r) {
		...
		var k = A2(
			...
			op,
			A2($author$project$Doc$lineOf, m, r));
		var rest = A2($elm$core$String$dropLeft, k, r.Q);
		var box = A3($elm$core$String$slice, opened, k, r.Q);
		var mark = (k <= 0) ? _List_Nil : A2(
			...
			A2(
				...
				A2(
					...
					op,
					A2($elm$core$String$left, opened, r.Q))),
...
var $author$project$Doc$viewKids = F6(
	function (lit, m, parent, from, at0, depth) {
		var tail = F2(
			function (mark, out) {
				return (_Utils_cmp(mark, parent.h) < 0) ? _Utils_ap(
					out,
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$text(
									A3($author$project$Scan$cut, m.aP, mark, parent.h))
								]))
						])) : out;
			});
		var rowN = function (j) {
			return A2($author$project$Scan$nth, j, m.D);
		};
		var n = $elm$core$List$length(m.D);
		var go = F3(
			function (j, mark, out) {
							...
							var gap = (_Utils_cmp(kid.d, mark) > 0) ? _List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text(
											A3($author$project$Scan$cut, m.aP, mark, kid.d))
										]))
								]) : _List_Nil;
							var _v1 = function () {
								if (under) {
									...
									var own = (_Utils_cmp(headAt, kid.d) > 0) ? _List_fromArray(
										[
											...
											_Utils_update(
												kid,
												{
													Q: A3($author$project$Scan$cut, m.aP, kid.d, headAt),
													h: headAt
												}))
										]) : _List_Nil;
	...
	function (lit, m, parent, from) {
		var walk = F2(
			function (j, got) {
				walk:
				while (true) {
					var _v0 = A2($author$project$Scan$nth, j, m.D);
					if (!_v0.$) {
						var kid = _v0.a;
						if ((kid.k === 3) && _Utils_eq(
							kid.v,
							$elm$core$Maybe$Just(parent.c))) {
							var $temp$j = j + 1,
								$temp$got = _Utils_ap(
		...
		if (r.k === 2) {
			...
			if (r.y === 1) {
				return A2($author$project$Doc$drawer, m, r) ? (':' + ($elm$core$String$toUpper(
					A2($elm$core$Maybe$withDefault, 'drawer', r.an)) + ':')) : A2($elm$core$Maybe$withDefault, 'item', r.an);
			} else {
				return clip(
					function () {
						var _v0 = _Utils_Tuple2(
							r.k,
							$author$project$Body$readProperty(r.Q));
						if ((_v0.a === 3) && (!_v0.b.$)) {
							var _v1 = _v0.a;
							var _v2 = _v0.b.a;
							var key = _v2.a;
...
var $author$project$Doc$view = function (m) {
	...
	var opener = function (r) {
		return (r.k === 3) ? $author$project$Doc$token('PROPERTIES') : _List_fromArray(
			[
				$elm$html$Html$text(
				A2(
					$elm$core$Maybe$withDefault,
					'',
					A2($author$project$Scan$nth, r.d, m.aP)))
			]);
	};
	var n = $elm$core$List$length(m.D);
			...
			while (true) {
				if (_Utils_cmp(i, n) > -1) {
					...
					var r = A2(
						...
						$author$project$Body$blank,
						A2($author$project$Scan$nth, i, m.D));
					if ((r.k === 2) && (_Utils_cmp(r.W, level) < 1)) {
						return _Utils_Tuple2(out, i);
					} else {
						if (A2($elm$core$Set$member, r.c, hidden)) {
							...
							if (r.k === 2) {
								...
								var _v0 = A3(go, i + 1, r.W, _List_Nil);
								var inner = _v0.a;
								var j = _v0.b;
								var $temp$i = j,
									$temp$level = level,
								...
								if (r.y === 1) {
									var _v1 = (r.k === 3) ? A4($author$project$Doc$viewMeta, lit, m, r, i + 1) : A6($author$project$Doc$viewKids, lit, m, r, i + 1, r.d, 0);
									var inner = _v1.a;
									var j = _v1.b;
									var shown = A2($elm$core$Set$member, r.c, m.g) ? _List_fromArray(
										[
											A2(
											$elm$html$Html$div,
											_List_fromArray(
	...
	var body = function () {
		...
		if (_v2.b) {
			...
			var _v3 = A3(go, 1, m.W, _List_Nil);
			var inner = _v3.a;
			return A2(
				$elm$core$List$cons,
				headline,
				A3(blkOf, 'H', m.W, inner));
		} else {
			return _List_Nil;
		}
	}();
